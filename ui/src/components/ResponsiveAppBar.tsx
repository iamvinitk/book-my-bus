...
function ResponsiveAppBar(): JSX.Element {
  ...
  const userDetails = JSON.parse(localStorage.getItem(CONSTANTS.USER) ?? "{}");
  console.log(userDetails, !("username" in userDetails));
        ...
        <Toolbar disableGutters>
          ...
          <Box sx={{ flexGrow: 0 }} className="flex items-center">
            ...
            <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}>
              ...
              <Avatar
                alt={firstName}
                src={`https://www.gravatar.com/avatar/#lcase(Hash(lcase(${email})))#?r=R`}
              />
            </IconButton>
